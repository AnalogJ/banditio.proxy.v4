...
def response(context, flow):
    ...
    with SessionToken(token):
        ...
        # ws.send(json.dumps({"msg": 'banditio.proxy connected'}))
        # ws.send(json.dumps({
        #     "method": "Network.requestWillBeSent",
        #     "params": {
        #         "requestId": entry.objectId,
        #         "frameId": "7897.1",
        #         "loaderId": "7897.3",
        #         "documentURL": entry.request['url'],
        #         "request": entry.request,
        #         "timestamp": flow.request.timestamp_start, #88986.634829,
        #         "wallTime": flow.request.timestamp_start, #1440472453.19435,
